package com.informatika.mizaastika_19100026_todolist
...
import com.informatika.mizaastika_19100026_todolist.adapter.ListContent
import com.informatika.mizaastika_19100026_todolist.model.ResponseActionBarang
import com.informatika.mizaastika_19100026_todolist.model.ResponseBarang
...
class UpdateDataActivity : AppCompatActivity() {
    ...
    fun actionData(id : String, namaBarang : String, jmlBarang : String, kodeBarang: String, hargaBarang: String){
        koneksi.service.updateBarang(id, namaBarang, jmlBarang, kodeBarang, hargaBarang).enqueue(object :
